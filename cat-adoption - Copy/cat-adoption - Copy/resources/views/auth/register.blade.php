<x-guest-layout>
    <!-- Decorative Pawprints background on outside form should be full -->
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 relative overflow-hidden py-12">
        ...
        <!-- Pawprints Background: Ensure it covers the full screen -->
        ...
        <!-- Register Form Container: Ensure semi-transparent background -->
        <div class="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-200 via-purple-200 to-blue-200 py-12 z-10">
            <div class="relative bg-transparent backdrop-blur-md shadow-md rounded-2xl p-10 w-full max-w-md border border-purple-200 z-10">
                <div class="text-center mb-6">
                    <h1 class="text-3xl font-extrabold text-gray-800 mb-2">🐾 Create Account</h1>
                    <p class="text-gray-500">Join our lovely cat adoption family 🐱</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                            ...
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 text-gray-700 placeholder-gray-400 bg-transparent backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent">
    ...
    <!-- Tailwind animations for pawprints -->
    <style>
