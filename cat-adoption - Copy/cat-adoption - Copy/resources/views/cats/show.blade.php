    ...
    <div class="max-w-5xl w-full bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col md:flex-row">
        ...
        <div class="md:w-1/2 p-8 flex flex-col justify-center">
            ...
            <div class="flex space-x-4">
                <a href="#" class="bg-pink-500 text-white px-6 py-2 rounded-full hover:bg-pink-600 transition">Apply for Adoption 💕</a>
                <a href="{{ route('adopt.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-full hover:bg-gray-300 transition">Back</a>
